// TargetTrader Service Worker v4.4.4
const CACHE_NAME = 'targettrader-v4.4.4';
const STATIC_CACHE = 'targettrader-static-v4.4.4';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing v4.4.4...');
    event.waitUntil(
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating v4.4.4...');
    event.waitUntil(
        caches.keys()
...
console.log('[SW] Service Worker loaded - v4.4.4');
