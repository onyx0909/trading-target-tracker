// TargetTrader Service Worker v4.4.5
const CACHE_NAME = 'targettrader-v4.4.5';
const STATIC_CACHE = 'targettrader-static-v4.4.5';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing v4.4.5...');
    event.waitUntil(
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating v4.4.5...');
    event.waitUntil(
        caches.keys()
...
console.log('[SW] Service Worker loaded - v4.4.5');
